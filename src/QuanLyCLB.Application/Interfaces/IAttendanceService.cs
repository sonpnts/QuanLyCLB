...
public interface IAttendanceService
{
    ...
    Task<IReadOnlyCollection<AttendanceRecordDto>> GetAttendanceByInstructorAsync(Guid instructorId, DateOnly fromDate, DateOnly toDate, CancellationToken cancellationToken = default);
